            ...
            <div className="relative z-10 w-full max-w-md my-8">
                <div className="glass-card rounded-2xl border border-border bg-card/60 p-8 backdrop-blur shadow-[0_24px_80px_oklch(0.58_0.2_255_/_12%)]">
                    ...
                    <div className="flex flex-col items-center text-center mb-8">
                        ...
                        <h1 className="text-xl font-bold tracking-tight text-glow">Create account</h1>
                        <p className="text-xs text-muted-foreground mt-1">Get started optimizing your resume parameters</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            {nameTouched && !isNameValid && (
                                <span className="text-[10px] text-red-500 block">Name must be at least 2 characters.</span>
                            )}
                        </div>
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs text-muted-foreground font-medium block">Confirm Password</label>
                            <div className="relative">
                                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-muted-foreground/70" />
                                <input
                        ...
                        <div className="flex items-start gap-2 pt-1">
                            <input
                                ...
                                className="mt-1 size-3.5 rounded bg-secondary border border-border accent-primary"
                            />
                            <label htmlFor="terms" className="text-[10px] text-muted-foreground leading-normal">
                                I agree to the{" "}
                                <span className="text-muted-foreground hover:text-foreground cursor-pointer underline">Terms of Service</span>{" "}
                                and{" "}
                                <span className="text-muted-foreground hover:text-foreground cursor-pointer underline">Privacy Policy</span>.
                            </label>
                        </div>
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase">
                            <span className="bg-background/80 px-2 text-muted-foreground font-mono">Or join with</span>
                        </div>
                    </div>
                    ...
                    <p className="mt-6 text-center text-xs text-muted-foreground">
                        ...
                        <Link href="/login" className="text-foreground/80 hover:text-foreground underline-offset-4 hover:underline font-semibold font-mono">
                            Sign In
                        </Link>
                    </p>
                </div>
